...
export const SERVICES: ServiceConfig = {
  gemma: import.meta.env.VITE_GEMMA_URL || window.__CONFIG__?.gemma || defaults.gemma,
...
export const API = {
  ...
  gemma: {
    base: SERVICES.gemma,
    health: `${SERVICES.gemma}/api/health`,
    status: `${SERVICES.gemma}/api/status`,
    devices: `${SERVICES.gemma}/api/devices`,
    games: `${SERVICES.gemma}/api/games`,
    runs: `${SERVICES.gemma}/api/runs`,
    sut: (id: string) => `${SERVICES.gemma}/api/sut/${id}`,
  },
  // Discovery Service
  discovery: {
