    ...
    <div className="flex flex-col h-[100dvh] bg-background overflow-hidden">
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-surface border-t border-border z-40">
        ...
        <div className="flex items-center justify-center gap-4 px-3 py-1.5 border-b border-border/50 bg-surface-elevated">
          <div className="flex items-center gap-1" title="Raptor X Backend">
            <Brain className={`w-3.5 h-3.5 ${services?.rpxBackend?.status === 'online' ? 'text-success' : 'text-danger'}`} />
            <span className="text-[10px] text-text-muted">RPX</span>
          </div>
