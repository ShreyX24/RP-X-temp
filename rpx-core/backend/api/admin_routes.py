...
Shares configuration with Service Manager (~/.rpx/service_manager_config.json)
"""
...
def get_default_config() -> Dict[str, Any]:
    ...
    return {
        ...
        "services": {
            ...
            "rpx-backend": {"host": "localhost", "port": 5000, "enabled": True, "remote": False, "env_vars": {}},
            "rpx-frontend": {"host": "localhost", "port": 3000, "enabled": True, "remote": False, "env_vars": {}},
        ...
        for name, settings in services.items():
            ...
            if settings.get('enabled', True) and port > 0:
                try:
                    ...
                    if name == 'rpx-frontend' or name == 'pm-frontend':
