...
Configuration Sources (in priority order):
    1. Config file: ~/.rpx/service_manager_config.json (preferred)
...
class AccountPoolManager:
    ...
    def _load_from_config_file(self) -> bool:
        """Load account pairs from ~/.rpx/service_manager_config.json"""
        config_path = Path.home() / ".rpx" / "service_manager_config.json"
